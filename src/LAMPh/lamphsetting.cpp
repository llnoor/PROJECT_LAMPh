...
LAMPhSetting::LAMPhSetting(QString loginQString)
{
    ...
    *login = loginQString;
    ...
    labelPlotSettingS = new QLabel(tr("LAMPhSetting"));
    ...
    setWindowTitle(tr("LAMPhSetting - %1 ").arg(login->toLower()));
    //showFullScreen();
    showMaximized();

}

QToolBar *LAMPhSetting::toolBar()
{
    ...
    d_OpenWindow_Setting->setEnabled(false);
...
QGroupBox *LAMPhSetting::groupLAMPhSetting()
{
