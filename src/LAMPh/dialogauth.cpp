...
QGroupBox *DialogAuth::groupTableAuth()
{
  ...
  checkScientistPass = new QLineEdit();

  scientistPass->setEchoMode(QLineEdit::Password);
  checkScientistPass->setEchoMode(QLineEdit::Password);
  ...
  gridLayout->addWidget(checkScientistPass,5,1);
  ...
  gridLayout->addWidget(loginButton,15,0);
