...
LAMPHLIBSHARED_EXPORT bool connect(int number_of_device); //This Lib will be connected with the device
...
LAMPHLIBSHARED_EXPORT bool start(int number_of_device); //LAMPh (measurement) is started
LAMPHLIBSHARED_EXPORT bool stop(int number_of_device); //LAMPh (measurement) is stopped
LAMPHLIBSHARED_EXPORT bool pause(int number_of_device); //LAMPh (measurement) is paused
LAMPHLIBSHARED_EXPORT bool exit(int number_of_device); //LAMPh is closing
