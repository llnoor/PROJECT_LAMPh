 ...
 *                         IVISPECAN                               
 *---------------------------------------------------------------------------
 *    Copyright (c) 2009 National Instruments.  All Rights Reserved.        
 *---------------------------------------------------------------------------
 *                                                                          
 * Title:       IviSpecAn.h                                                    
...
#define IVISPECAN_CLASS_SPEC_MAJOR_VERSION   (1L)
...
#define IVISPECAN_WARNMSG_MEASURE_UNCALIBRATED "Uncalibrated measurement"
#define IVISPECAN_WARNMSG_OVER_RANGE           "Measurement overrange"

#define IVISPECAN_ERRMSG_MARKER_NOT_ENABLED    "Marker Not Enabled"
#define IVISPECAN_ERRMSG_NOT_DELTA_MARKER      "Not Delta Marker"
#define IVISPECAN_ERRMSG_MAX_TIME_EXCEEDED     "Max Time Exceeded"
