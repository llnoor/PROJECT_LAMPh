 ...
 *                              I V I - D M M                               
 *---------------------------------------------------------------------------
 *    Copyright (c) 1999-2009 National Instruments.  All Rights Reserved.        
 *---------------------------------------------------------------------------
 *                                                                          
 * Title:       ividmm.h                                                    
...
#define IVIDMM_CLASS_SPEC_MAJOR_VERSION     (3L)
#define IVIDMM_CLASS_SPEC_MINOR_VERSION     (0L)
...
#define IVIDMM_ERRMSG_MAX_TIME_EXCEEDED     "Max Time exceeded before "\
                                            "operation completed."
#define IVIDMM_ERRMSG_TRIGGER_NOT_SOFTWARE  "The trigger source is not "\
                                            "software trigger."
