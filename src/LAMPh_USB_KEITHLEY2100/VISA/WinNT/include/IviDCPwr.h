 ...
 *                           I V I - D C P W R                               
 *---------------------------------------------------------------------------
 *    Copyright (c) 2000-2009 National Instruments.  All Rights Reserved.        
 *---------------------------------------------------------------------------
 *                                                                          
 * Title:       ividcpwr.h                                                    
...
#define IVIDCPWR_CLASS_SPEC_MAJOR_VERSION   (2L)
...
#define IVIDCPWR_ERRMSG_TRIGGER_NOT_SOFTWARE  "The trigger source is not software trigger."
