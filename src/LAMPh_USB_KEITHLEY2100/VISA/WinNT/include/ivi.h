...
/*                               I V I                                        */
/*----------------------------------------------------------------------------*/
/*    Copyright (c) 1998-2003 National Instruments.  All Rights Reserved.       */
/*----------------------------------------------------------------------------*/
/*                                                                            */
/* Title:       ivi.h                                                         */
...
#ifndef _IVI_mswin32_
#if (defined(WIN32) || defined(_WIN32) || defined(__WIN32__) || defined(__NT__) || defined(_NI_mswin32_))
#define _IVI_mswin32_
#endif
#endif

#ifndef _IVI_mswin64_
#if (defined (_VISA_ENV_IS_64_BIT) || defined (_WIN64))
#define _IVI_mswin64_
#endif
#endif

#if (defined (_IVI_mswin32_) && defined (_VI_INT64_UINT64_DEFINED))
...
/* Useful constants                                                 ======== */
/*****************************************************************************/
#define IVI_ENGINE_MAJOR_VERSION        4
#define IVI_ENGINE_MINOR_VERSION        100
...
#define Ivi_ConvertVISAVer(x)     ((((x>>20)*100)+(((x >> 8) & 0xFFF)*10)+(x & 0xFF))/100.0)
    ...
    #define IVI_COMPILER_VER_NUM    ((_MSC_VER - 600)/100.0)   
