 ...
 *                             I V I - S W T C H                             
 *---------------------------------------------------------------------------
 *    Copyright (c) 1998-2009 National Instruments.  All Rights Reserved.         
 *---------------------------------------------------------------------------
 *                                                                           
 * Title:       iviswtch.h                                                    
...
#define IVISWTCH_CLASS_SPEC_MAJOR_VERSION   (3L)
...
#define IVISWTCH_WARNMSG_PATH_REMAINS               "Some connections remain "\
                                                    "after disconnecting."
#define IVISWTCH_WARNMSG_IMPLICIT_CONNECTION_EXISTS "The channels are implicitly connected."

#define IVISWTCH_ERRMSG_INVALID_SWITCH_PATH         "Invalid path string."
#define IVISWTCH_ERRMSG_INVALID_SCAN_LIST           "Invalid Scan List string."
#define IVISWTCH_ERRMSG_RSRC_IN_USE                 "One of the channels is a "\
                                                    "configuration channel that is in use "\
                                                    "or is a common multiplexer channel "\
                                                    "that is in use."
#define IVISWTCH_ERRMSG_EMPTY_SCAN_LIST             "The scan list string is empty."
#define IVISWTCH_ERRMSG_EMPTY_SWITCH_PATH           "The path string is empty."
#define IVISWTCH_ERRMSG_SCAN_IN_PROGRESS            "The switch module is "\
                                                    "currently in scanning mode, and the "\
                                                    "operation cannot be performed at this time."
#define IVISWTCH_ERRMSG_NO_SCAN_IN_PROGRESS         "The switch module is not "\
                                                    "currently in scanning mode, and the "\
                                                    "operation cannot be performed at this time."
#define IVISWTCH_ERRMSG_NO_SUCH_PATH                "No explicit path exists "\
                                                    "between the two channels."
#define IVISWTCH_ERRMSG_IS_CONFIGURATION_CHANNEL    "You cannot make an explicit "\
                                                    "connection to a configuration channel."
#define IVISWTCH_ERRMSG_NOT_A_CONFIGURATION_CHANNEL "One of the non-terminal "\
                                                    "channels in the path is not a "\
                                                    "configuration channel."
#define IVISWTCH_ERRMSG_ATTEMPT_TO_CONNECT_SOURCES  "You cannot make a connection "\
...
#define IVISWTCH_ERRMSG_CHANNEL_DUPLICATED_IN_LEG   "The first and second "\
...
#define IVISWTCH_ERRMSG_TRIGGER_NOT_SOFTWARE        "The trigger source is not "\
                                                    "software trigger."

#define IVISWTCH_ERRMSG_MAX_TIME_EXCEEDED           "Max time exceeded."
