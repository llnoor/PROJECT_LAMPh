#ifndef COM_SR850_LIB_H
#define COM_SR850_LIB_H

#include "COM_SR850_global.h"
#include <QString>
#include <QStringList>
...
LAMPHLIBSHARED_EXPORT bool readData();  //if true dll is ready to transfer data to LAMPh!!!
